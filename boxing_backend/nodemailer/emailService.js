var nodemailer = require("nodemailer");
 ...
 async function forgotPasswordSender( email, name, password) {
    ...
    await transporter.sendMail({
      ...
      'Here are your password details details: <br> </div1>' +
  ...
  async function confirmationEmail(email, name) {
    ...
    await transporter.sendMail({
      from: '"BoxChamp Team" <boxchamp407@outlook.com',
      to: email, // must be email address.
      subject: 'Confirmation Email',
      text: '',
      html:
      '<body style="margin: auto; width: 75%; border: 1.5px solid #79c2d0; padding: 20px;">' +
      '<img src="cid:glovesicon" alt="Logo" style="border-radius: 30px; height: 50px; width: 130px;"/><h1 style="color:green;text-align:center;">  Hello ' + name + '! </h1> <br>'+
      '<div1 style="font-size: 28px; padding: 35px;"> Thank you for signing up to be part of <b>BoxChamp</b> great community! <br>' +
      '<br> </div1>' +
      '<div1 style="font-size: 28px; padding: 35px;"> This email was sent as a confirmation for joining our boxing service. <br>'+ '<br>Welcome to <b>BoxChamp</b> </div1>',       
      attachments: [
        {
          filename: 'glovesicon.png',
          path: '/home/kwabena/Desktop/BoxingWeb/boxing_ui/boxing_frontend/src/assets/glovesicon.png',
...
module.exports = {forgotPasswordSender, confirmationEmail};
